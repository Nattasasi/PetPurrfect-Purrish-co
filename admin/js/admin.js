...
import { collection, doc, onSnapshot, serverTimestamp, updateDoc, query, where, getCountFromServer, Timestamp } from "https://www.gstatic.com/firebasejs/12.17.1/firebase-firestore.js";
...
function switchView(requested) {
    const name = ["dashboard", "messages"].includes(requested) ? requested : "dashboard";
    ...
    $("view-title").textContent = name === "dashboard" ? "Dashboard" : "Messages";
